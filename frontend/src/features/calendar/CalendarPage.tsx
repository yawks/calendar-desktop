...
const DARK_THEME = {
  common: {
    ...
    today: { color: '#1c1e20', backgroundColor: '#6d9ee8' },
    gridSelection: { backgroundColor: 'rgba(109,158,232,0.1)', border: '1px solid #6d9ee8' },
  },
  week: {
    dayName: { borderLeft: 'none', borderTop: '1px solid #2a2a3c', borderBottom: '1px solid #2a2a3c', backgroundColor: '#171a1c' },
    dayGrid: { borderRight: '1px solid #2a2a3c', backgroundColor: '' },
    dayGridLeft: { borderRight: '1px solid #2a2a3c', backgroundColor: '#171a1c', width: '72px' },
    timeGrid: { borderRight: '1px solid #2a2a3c' },
    timeGridLeft: { backgroundColor: '#171a1c', borderRight: '1px solid #2a2a3c', width: '72px' },
  ...
  month: {
    dayName: { borderLeft: 'none', backgroundColor: '#171a1c', color: '#a8b4cc' },
    weekend: { backgroundColor: '#181826' },
    holidayExcessView: { color: '#c8607a' },
    dayExcessView: { color: '#a8b4cc' },
    moreView: { border: '1px solid #2a2a3c', backgroundColor: '#1c1e20', boxShadow: '0 4px 12px rgba(0,0,0,0.6)' },
    moreViewTitle: { backgroundColor: '#171a1c' },
  },
};
...
function toTUIEvents(events: CalendarEvent[], calendars: CalendarConfig[], isDark: boolean, tags: import('../../shared/types').Tag[], eventTags: import('../../shared/types').EventTagMapping) {
  const now = new Date();
