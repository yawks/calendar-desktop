...
/**
 * Handle image paste from clipboard into a contentEditable div.
 * Prevents the default paste of large data URLs and uploads them as attachments instead.
 */
export async function handleImagePaste(e: React.ClipboardEvent) {
  ...
  // In a real app, you would upload the image and insert its URL.
  // Here we just notify the user or handle it as an attachment.
