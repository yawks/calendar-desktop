...
class SyncBehaviorTest{
 ...
 @Test fun notificationSnippetDecodesEntitiesAndCollapsesLineBreaks(){assertEquals("Premiere ligne Deuxieme & suite",NativeNotifier.sanitizeNotificationText("Premiere ligne&#xD;&#xA;Deuxieme &amp;amp; suite"))}
 @Test fun notificationDisplaysSubjectBeforeSnippet(){assertEquals("Sujet & test\nPremière ligne\nDeuxième ligne",NativeNotifier.notificationBody(" Sujet &amp; test ","Première ligne\r\nDeuxième ligne"))}
}
