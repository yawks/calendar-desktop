        ...
        .invoke_handler({
            #[cfg(not(target_os = "macos"))]
            {
                tauri::generate_handler![
                    ...
                    ews::ews_cancel_event,
                    ews::ews_get_free_busy,
                    ews::ews_get_free_busy_ews,
                    mail::mail_list_folders,
                    mail::mail_list_threads,
                    mail::mail_get_thread_count,
                    mail::mail_get_thread,
                    mail::mail_get_thread_headers,
                    mail::mail_get_thread_snippet,
                    mail::mail_get_message_content,
                    ...
                    imap::imap_get_message_content,
                    imap::imap_get_thread_snippet,
                    imap::imap_mark_read,
                    ...
                    jmap::jmap_get_thread_count,
                    jmap::jmap_get_thread_snippet,
                    jmap::jmap_get_thread,
                    jmap::jmap_get_message_content,
                    jmap::jmap_get_raw_message,
                    jmap::jmap_mark_read,
                    ...
                    jmap::jmap_send,
                    jmap::jmap_get_capabilities,
                    jmap::jmap_get_scheduled_send,
                    jmap::jmap_cancel_scheduled_send,
